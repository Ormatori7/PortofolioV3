...
export interface AllData extends Project{
  HugeCardData: Card3D[]; //ajoute a liste des cartes
  MenuImage: GalleryItem[]; // on ajoute la liste des images
  MapImage: string[]; // On garde un tableau de chaînes de caractères pour les URLs des images de la carte
}
